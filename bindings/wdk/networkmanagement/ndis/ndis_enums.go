...
// String returns the NDIS_CLASS_ID constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_CLASS_ID) String() string {
	switch e {
	case NdisClass802_3Priority:
		return "NdisClass802_3Priority"
	case NdisClassWirelessWanMbxMailbox:
		return "NdisClassWirelessWanMbxMailbox"
	case NdisClassIrdaPacketInfo:
		return "NdisClassIrdaPacketInfo"
	case NdisClassAtmAALInfo:
		return "NdisClassAtmAALInfo"
	default:
		return fmt.Sprintf("NDIS_CLASS_ID(%d)", int32(e))
	}
}
...
// String returns the NDIS_DEVICE_PNP_EVENT constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_DEVICE_PNP_EVENT) String() string {
	switch e {
	case NdisDevicePnPEventQueryRemoved:
		return "NdisDevicePnPEventQueryRemoved"
	case NdisDevicePnPEventRemoved:
		return "NdisDevicePnPEventRemoved"
	case NdisDevicePnPEventSurpriseRemoved:
		return "NdisDevicePnPEventSurpriseRemoved"
	case NdisDevicePnPEventQueryStopped:
		return "NdisDevicePnPEventQueryStopped"
	case NdisDevicePnPEventStopped:
		return "NdisDevicePnPEventStopped"
	case NdisDevicePnPEventPowerProfileChanged:
		return "NdisDevicePnPEventPowerProfileChanged"
	case NdisDevicePnPEventMaximum:
		return "NdisDevicePnPEventMaximum"
	default:
		return fmt.Sprintf("NDIS_DEVICE_PNP_EVENT(%d)", int32(e))
	}
}
...
// String returns the NDIS_ENVIRONMENT_TYPE constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_ENVIRONMENT_TYPE) String() string {
	switch e {
	case NdisEnvironmentWindows:
		return "NdisEnvironmentWindows"
	case NdisEnvironmentWindowsNt:
		return "NdisEnvironmentWindowsNt"
	default:
		return fmt.Sprintf("NDIS_ENVIRONMENT_TYPE(%d)", int32(e))
	}
}
...
// String returns the NDIS_INTERFACE_TYPE constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_INTERFACE_TYPE) String() string {
	switch e {
	case NdisInterfaceInternal:
		return "NdisInterfaceInternal"
	case NdisInterfaceIsa:
		return "NdisInterfaceIsa"
	case NdisInterfaceEisa:
		return "NdisInterfaceEisa"
	case NdisInterfaceMca:
		return "NdisInterfaceMca"
	case NdisInterfaceTurboChannel:
		return "NdisInterfaceTurboChannel"
	case NdisInterfacePci:
		return "NdisInterfacePci"
	case NdisInterfacePcMcia:
		return "NdisInterfacePcMcia"
	case NdisInterfaceCBus:
		return "NdisInterfaceCBus"
	case NdisInterfaceMPIBus:
		return "NdisInterfaceMPIBus"
	case NdisInterfaceMPSABus:
		return "NdisInterfaceMPSABus"
	case NdisInterfaceProcessorInternal:
		return "NdisInterfaceProcessorInternal"
	case NdisInterfaceInternalPowerBus:
		return "NdisInterfaceInternalPowerBus"
	case NdisInterfacePNPISABus:
		return "NdisInterfacePNPISABus"
	case NdisInterfacePNPBus:
		return "NdisInterfacePNPBus"
	case NdisInterfaceUSB:
		return "NdisInterfaceUSB"
	case NdisInterfaceIrda:
		return "NdisInterfaceIrda"
	case NdisInterface1394:
		return "NdisInterface1394"
	case NdisMaximumInterfaceType:
		return "NdisMaximumInterfaceType"
	default:
		return fmt.Sprintf("NDIS_INTERFACE_TYPE(%d)", int32(e))
	}
}
...
// String returns the NDIS_PARAMETER_TYPE constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_PARAMETER_TYPE) String() string {
	switch e {
	case NdisParameterInteger:
		return "NdisParameterInteger"
	case NdisParameterHexInteger:
		return "NdisParameterHexInteger"
	case NdisParameterString:
		return "NdisParameterString"
	case NdisParameterMultiString:
		return "NdisParameterMultiString"
	case NdisParameterBinary:
		return "NdisParameterBinary"
	default:
		return fmt.Sprintf("NDIS_PARAMETER_TYPE(%d)", int32(e))
	}
}
...
// String returns the NDIS_PER_PACKET_INFO constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_PER_PACKET_INFO) String() string {
	switch e {
	case TcpIpChecksumPacketInfo:
		return "TcpIpChecksumPacketInfo"
	case IpSecPacketInfo:
		return "IpSecPacketInfo"
	case TcpLargeSendPacketInfo:
		return "TcpLargeSendPacketInfo"
	case ClassificationHandlePacketInfo:
		return "ClassificationHandlePacketInfo"
	case NdisReserved:
		return "NdisReserved"
	case ScatterGatherListPacketInfo:
		return "ScatterGatherListPacketInfo"
	case Ieee8021QInfo:
		return "Ieee8021QInfo"
	case OriginalPacketInfo:
		return "OriginalPacketInfo"
	case PacketCancelId:
		return "PacketCancelId"
	case OriginalNetBufferList:
		return "OriginalNetBufferList"
	case CachedNetBufferList:
		return "CachedNetBufferList"
	case ShortPacketPaddingInfo:
		return "ShortPacketPaddingInfo"
	case MaxPerPacketInfo:
		return "MaxPerPacketInfo"
	default:
		return fmt.Sprintf("NDIS_PER_PACKET_INFO(%d)", int32(e))
	}
}
...
// String returns the NDIS_POWER_PROFILE constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_POWER_PROFILE) String() string {
	switch e {
	case NdisPowerProfileBattery:
		return "NdisPowerProfileBattery"
	case NdisPowerProfileAcOnLine:
		return "NdisPowerProfileAcOnLine"
	default:
		return fmt.Sprintf("NDIS_POWER_PROFILE(%d)", int32(e))
	}
}
...
// String returns the NDIS_PROCESSOR_TYPE constant's name, or its numeric form when
// the value is not a known constant.
func (e NDIS_PROCESSOR_TYPE) String() string {
	switch e {
	case NdisProcessorX86:
		return "NdisProcessorX86"
	case NdisProcessorMips:
		return "NdisProcessorMips"
	case NdisProcessorAlpha:
		return "NdisProcessorAlpha"
	case NdisProcessorPpc:
		return "NdisProcessorPpc"
	case NdisProcessorAmd64:
		return "NdisProcessorAmd64"
	case NdisProcessorIA64:
		return "NdisProcessorIA64"
	case NdisProcessorArm:
		return "NdisProcessorArm"
	case NdisProcessorArm64:
		return "NdisProcessorArm64"
	default:
		return fmt.Sprintf("NDIS_PROCESSOR_TYPE(%d)", int32(e))
	}
}
