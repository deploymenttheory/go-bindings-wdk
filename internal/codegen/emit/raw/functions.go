...
import (
	...
	"github.com/deploymenttheory/go-bindings-wdk/internal/codegen/emit/raw/view"
	"github.com/deploymenttheory/go-bindings-wdk/internal/codegen/naming"
	"github.com/deploymenttheory/go-bindings-wdk/internal/codegen/typemap"
...
func (g *Generator) buildFunction(meta *win32meta.NamespaceMeta, function *win32meta.Function, rawName string, imports typemap.ImportSet) (view.FunctionModel, bool) {
	...
	for i := range function.Params {
		...
		// callee that reenters Go (consumer NewCallback delegates) can move
		// this goroutine's stack, stranding any stack out-pointer — see the
		// go-bindings-win32 runtime's outparam.go.
...
const foundationApi = "Win32.Foundation"
