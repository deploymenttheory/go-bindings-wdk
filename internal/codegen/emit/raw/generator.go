// Package rawwin emits the WDK bindings: one Go package per Windows.Wdk
// namespace under bindings/wdk/, dispatching through syscall.SyscallN.
// External Win32. namespaces resolve to the published go-bindings-win32
// module and are never emitted here.
package rawwin
...
import (
	...
	"github.com/deploymenttheory/go-bindings-wdk/internal/codegen/emit/raw/render"
	...
	"github.com/deploymenttheory/go-bindings-wdk/internal/codegen/shared/fileasm"
...
func New(registry *pipeline.Registry, modulePath, outDir string) *Generator {
	return &Generator{
		...
		mapper: &typemap.Mapper{
			...
			Win32ModulePath:   win32ModulePath,
			LocalBindingsRoot: "/bindings/wdk/",
...
// are ever deleted.
const generatedHeader = "// Code generated by go-bindings-wdk-codegen. DO NOT EDIT."

// win32ModulePath hosts the external Win32. namespaces (the published
// win32 bindings) and the shared runtime package.
...
const apiRootPrefix = "Windows.Wdk."
